...
// after inserting data, AUTOMATICALLY go to shotList.php to finalize.

//$updateGoTo = "shotList.php?slTitleID=" . $_POST['slTitleID'] ;
//header(sprintf("Location: %s", $updateGoTo));

?>

<h3><a name="titlelisting" id="titlelisting"></a>To finish the import, <a href="shotList.php?slTitleID=<?php 
