...
$query_rsTitleListing = "SELECT * FROM sl_Title2  LEFT JOIN `sl_ImdbMap`  USING (IMDbID)  ORDER BY `MedianShotLength` ASC";
...
<h1>Summary Data Table<!-- Created by Spry--></h1>
 ...
 <h2><em>Sorted by MSL (Median Shot Length).</em></h2>
