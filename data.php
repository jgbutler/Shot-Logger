...
try {
        ...
        $sql = "SELECT * FROM sl_Title2  LEFT JOIN `sl_ImdbMap`  USING (IMDbID)  ORDER BY `ImdbTitle` ASC";
...
<h1>Summary Data Table<!-- Created by Spry--></h1>
 ...
 <h2><em>Sorted by IMDb Title.</em></h2>
...
<table border="1" align="center">
  <tr>
    <td valign="top"><strong>IMDb Title</strong><br />
