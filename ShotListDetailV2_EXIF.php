...
<table border="1" align="center">
  <tr>
    <td colspan="2"><img src="images/<?php echo $row_DetailRS1['sl_directory'] . $row_DetailRS1['filename']; ?>" alt="Frame grab: <?php echo $row_DetailRS1['filename']; ?>" /></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><?php if ($row_DetailRS1['DateSubmitted'] != '0000-00-00 00:00:00') {
