...
$query_rsTitleListing = "SELECT * FROM sl_Title2  LEFT JOIN `sl_ImdbMap`  USING (IMDbID)  ORDER BY `ImdbTitle` ASC";
...
<h1>Summary Data Table<!-- Created by Spry--></h1>
 <p>All time measurements are in seconds. &quot;MSL&quot; = &quot;median shot length&quot; and &quot;ASL&quot; = &quot;average shot length&quot;.</p>
 <p><strong>Click an &quot;<em>SL Title</em>&quot; link to see more Shot Logger data about that program or film.</strong></p>
 <p>Some TV shows are divided into several parts (to cope with commercial breaks).</p>
